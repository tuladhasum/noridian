<div class="sidebar">
    <nav class="sidebar-nav ps ps--active-y">
        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{ route("admin.examples.index") }}" class="nav-link {{ request()->is('admin/examples') || request()->is('admin/examples/*') ? 'active' : '' }}">
                    <i class="fas fa-allergies nav-icon">

                    </i>
                    {{ trans('global.example.title') }}
                </a>
            </li>
            <li class="nav-item">
